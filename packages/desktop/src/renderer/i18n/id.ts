export const dict = {
  ...
  "desktop.updater.none.message": "Anda sudah menggunakan versi terbaru YarpNeuro",
  ...
  "desktop.updater.downloaded.prompt":
    "YarpNeuro versi {{version}} telah diunduh. Apakah Anda ingin menginstalnya dan menjalankan ulang aplikasi?",
