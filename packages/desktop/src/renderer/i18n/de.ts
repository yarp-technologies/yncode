export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von YarpNeuro",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von YarpNeuro wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
