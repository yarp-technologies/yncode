export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de YarpNeuro",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de YarpNeuro. ¿Quieres instalarla y reiniciar?",
