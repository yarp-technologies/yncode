export const dict = {
  ...
  "desktop.updater.none.message": "Već koristite najnoviju verziju YarpNeuro",
  ...
  "desktop.updater.downloaded.prompt":
    "Preuzeta je verzija {{version}} aplikacije YarpNeuro. Želite li je instalirati i ponovno pokrenuti aplikaciju?",
