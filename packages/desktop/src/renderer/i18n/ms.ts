export const dict = {
  ...
  "desktop.updater.none.message": "Anda sudah menggunakan versi terkini YarpNeuro",
  ...
  "desktop.updater.downloaded.prompt":
    "Versi {{version}} YarpNeuro telah dimuat turun, adakah anda ingin memasangnya dan melancarkan semula?",
