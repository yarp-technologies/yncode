export const dict = {
  ...
  "desktop.updater.none.message": "Ви вже використовуєте найновішу версію YarpNeuro",
  ...
  "desktop.updater.downloaded.prompt":
    "Версію {{version}} YarpNeuro завантажено. Бажаєте встановити її та перезапустити?",
