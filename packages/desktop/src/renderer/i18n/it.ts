export const dict = {
  ...
  "desktop.updater.none.message": "Stai già utilizzando l'ultima versione di YarpNeuro",
  ...
  "desktop.updater.downloaded.prompt":
    "La versione {{version}} di YarpNeuro è stata scaricata. Vuoi installarla e riavviare l'app?",
