export const dict = {
  ...
  "desktop.updater.none.message": "Du använder redan den senaste versionen av YarpNeuro",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} av YarpNeuro har laddats ned. Vill du installera den och starta om programmet?",
