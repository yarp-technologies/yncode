export const dict = {
  ...
  "desktop.updater.none.message": "Je gebruikt al de nieuwste versie van YarpNeuro",
  ...
  "desktop.updater.downloaded.prompt":
    "Versie {{version}} van YarpNeuro is gedownload. Wil je deze installeren en YarpNeuro opnieuw starten?",
