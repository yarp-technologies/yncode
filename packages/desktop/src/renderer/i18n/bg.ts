export const dict = {
  ...
  "desktop.updater.none.message": "Вече използвате най-новата версия на YarpNeuro",
  ...
  "desktop.updater.downloaded.prompt":
    "Версия {{version}} от YarpNeuro е изтеглена. Искате ли да я инсталирате и рестартирате?",
