export const dict = {
  ...
  "desktop.updater.none.message": "Ju tashmë po përdorni versionin më të fundit të YarpNeuro",
  ...
  "desktop.updater.downloaded.prompt":
    "Versioni {{version}} i YarpNeuro është shkarkuar, dëshironi ta instaloni dhe rinisni?",
