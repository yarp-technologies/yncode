export const dict = {
  ...
  "desktop.updater.none.message": "Artıq YarpNeuro-un ən son versiyasından istifadə edirsiniz",
  ...
  "desktop.updater.downloaded.prompt":
    "YarpNeuro-un {{version}} versiyası yüklənib. Onu quraşdırıb tətbiqi yenidən başlatmaq istəyirsiniz?",
