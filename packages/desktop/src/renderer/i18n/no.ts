export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av YarpNeuro",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av YarpNeuro er lastet ned. Vil du installere den og starte på nytt?",
