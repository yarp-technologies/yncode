export const dict = {
  ...
  "desktop.updater.none.message": "Folosești deja cea mai recentă versiune YarpNeuro",
  ...
  "desktop.updater.downloaded.prompt":
    "Versiunea {{version}} YarpNeuro a fost descărcată. Vrei să o instalezi și să repornești?",
