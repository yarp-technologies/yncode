export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji YarpNeuro",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} YarpNeuro. Czy chcesz ją zainstalować i uruchomić ponownie?",
