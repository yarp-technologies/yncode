export const dict = {
  ...
  "desktop.updater.none.message": "Že uporabljate najnovejšo različico YarpNeuro",
  ...
  "desktop.updater.downloaded.prompt":
    "Različica {{version}} YarpNeuro je bila prenesena, jo želite namestiti in znova zagnati?",
