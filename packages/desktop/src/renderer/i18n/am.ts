export const dict = {
  ...
  "desktop.updater.none.message": "አሁን የቅርብ ጊዜውን የYarpNeuro ስሪት እየተጠቀሙ ነው",
  ...
  "desktop.updater.downloaded.prompt": "ስሪት {{version}} ከYarpNeuro ወርዷል፣ መጫን እና እንደገና ማስጀመር ይፈልጋሉ?",
