export const dict = {
  ...
  "desktop.updater.none.message": "Већ користите најновију верзију YarpNeuro",
  ...
  "desktop.updater.downloaded.prompt":
    "Верзија {{version}} од YarpNeuro је преузета, да ли желите да је инсталирате и поново покренете?",
