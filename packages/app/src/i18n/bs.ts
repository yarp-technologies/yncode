export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacija za YarpNeuro",
  ...
  "desktop.menu.ariaLabel": "YarpNeuro meni",
  ...
  "desktop.recovery.loadFailed": "YarpNeuro se nije uspio učitati",
  "desktop.recovery.terminated": "Prozor YarpNeuro-a neočekivano je zatvoren",
  "desktop.recovery.unresponsive": "YarpNeuro ne reaguje",
  ...
  "desktop.wsl.error.installOpencode": "Instalacija YarpNeuro-a nije uspjela",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "YarpNeuro nije instaliran u distribuciji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Ažuriranje YarpNeuro-a je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje YarpNeuro",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u YarpNeuro-u.",
  ...
  "provider.connect.opencodeZen.line1":
    "YarpNeuro Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u YarpNeuro-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u YarpNeuro-u.",
  ...
  "dialog.server.description": "Promijeni na koji se YarpNeuro server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Provjera YarpNeuro...",
  "wsl.onboarding.checkingOpencodeIn": "Provjera YarpNeuro u distribuciji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje YarpNeuro...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje YarpNeuro u distribuciji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažuriraj YarpNeuro u distribuciji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažuriraj YarpNeuro",
  "wsl.onboarding.opencodeReadyIn": "YarpNeuro je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.opencodeReady": "YarpNeuro je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instaliraj YarpNeuro u distribuciji {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaliraj YarpNeuro",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "YarpNeuro nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi YarpNeuro mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "YarpNeuro nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori YarpNeuro.",
  ...
  "help.tabs.introduction": "YarpNeuro Desktop sada je organizovan oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija YarpNeuro-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku YarpNeuro timu",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: YarpNeuro još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "YarpNeuro uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni YarpNeuro server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u YarpNeuro-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako YarpNeuro izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li YarpNeuro prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu YarpNeuro-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se YarpNeuro pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju YarpNeuro-a.",
