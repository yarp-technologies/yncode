export const dict = {
  ...
  "desktop.menu.documentation": "YarpNeuro-documentatie",
  ...
  "desktop.recovery.loadFailed": "YarpNeuro kan niet worden geladen",
  "desktop.recovery.terminated": "Het YarpNeuro-venster is onverwacht beëindigd",
  "desktop.recovery.unresponsive": "YarpNeuro reageert niet",
  ...
  "desktop.wsl.error.installOpencode": "Installatie van YarpNeuro is mislukt",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "YarpNeuro is niet geïnstalleerd in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "De YarpNeuro-update is voltooid, maar {{distro}} meldt nog steeds {{installed}}; verwacht: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modellen geleverd door YarpNeuro",
  ...
  "provider.connect.apiKey.description":
    "Voer je {{provider}}-API-sleutel in om je account te koppelen en {{provider}}-modellen in YarpNeuro te gebruiken.",
  ...
  "provider.connect.opencodeZen.line1":
    "YarpNeuro Zen geeft je toegang tot een samengestelde set betrouwbare, geoptimaliseerde modellen voor codeeragenten.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " om je autorisatiecode op te halen, je account te koppelen en {{provider}}-modellen in YarpNeuro te gebruiken.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om je account te koppelen en {{provider}}-modellen in YarpNeuro te gebruiken.",
  ...
  "dialog.server.description": "Wijzig met welke YarpNeuro-server deze app verbinding maakt.",
  ...
  "wsl.onboarding.checkingOpencode": "YarpNeuro controleren...",
  "wsl.onboarding.checkingOpencodeIn": "YarpNeuro controleren in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "YarpNeuro bijwerken...",
  "wsl.onboarding.updatingOpencodeIn": "YarpNeuro bijwerken in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Werk YarpNeuro bij in {{distro}}.",
  "wsl.onboarding.updateOpencode": "YarpNeuro bijwerken",
  "wsl.onboarding.opencodeReadyIn": "YarpNeuro is gereed in {{distro}}.",
  "wsl.onboarding.opencodeReady": "YarpNeuro is klaar.",
  "wsl.onboarding.installOpencodeIn": "Installeer YarpNeuro in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installeer YarpNeuro",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "YarpNeuro niet geïnstalleerd",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows-subsysteem voor Linux) is vereist voordat YarpNeuro een WSL-server kan toevoegen",
  "wsl.onboarding.wslUnavailable.title": "WSL niet beschikbaar",
  "wsl.onboarding.wslUnavailable.description": "YarpNeuro kan WSL niet verifiëren op deze machine.",
  "wsl.onboarding.installWsl": "Installeer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows opnieuw om de installatie van WSL te voltooien en open vervolgens YarpNeuro opnieuw.",
  ...
  "help.tabs.introduction": "YarpNeuro Desktop is nu opgebouwd rond tabbladen.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Er is nu een nieuwe versie van YarpNeuro ({{version}}) beschikbaar om te installeren.",
  ...
  "error.page.report.prefix": "Rapporteer deze fout aan het YarpNeuro-team",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" is mislukt. Let op: YarpNeuro ondersteunt nog geen MCP-authenticatie.',
  ...
  "sidebar.gettingStarted.line1": "YarpNeuro bevat gratis modellen, zodat je direct aan de slag kunt.",
  ...
  "settings.desktop.wsl.description": "Voer de YarpNeuro-server uit in WSL op Windows.",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor YarpNeuro",
  ...
  "settings.general.row.appearance.description": "Pas aan hoe YarpNeuro eruitziet op je apparaat",
  "settings.general.row.colorScheme.title": "Kleurenschema",
  "settings.general.row.colorScheme.description":
    "Kies of YarpNeuro het systeemthema, het lichte thema of het donkere thema gebruikt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van YarpNeuro aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer YarpNeuro wordt gestart",
  ...
  "settings.updates.toast.latest.title": "YarpNeuro is bijgewerkt",
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van YarpNeuro.",
