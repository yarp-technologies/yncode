...
export const dict = {
  ...
  "desktop.menu.documentation": "YarpNeuro-dokumentasjon",
  ...
  "desktop.menu.ariaLabel": "YarpNeuro-meny",
  ...
  "desktop.recovery.loadFailed": "YarpNeuro kunne ikke lastes inn",
  "desktop.recovery.terminated": "YarpNeuro-vinduet ble uventet avsluttet",
  "desktop.recovery.unresponsive": "YarpNeuro svarer ikke",
  ...
  "desktop.wsl.error.installOpencode": "Installasjonen av YarpNeuro mislyktes",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "YarpNeuro er ikke installert i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Oppdateringen av YarpNeuro er fullført, men {{distro}} rapporterer fortsatt {{installed}}; forventet {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av YarpNeuro",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn API-nøkkelen din for {{provider}} for å koble til kontoen din og bruke {{provider}}-modeller i YarpNeuro.",
  ...
  "provider.connect.opencodeZen.line1":
    "YarpNeuro Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i YarpNeuro.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i YarpNeuro.",
  ...
  "dialog.server.description": "Bytt hvilken YarpNeuro-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av YarpNeuro ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til YarpNeuro-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at YarpNeuro ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "YarpNeuro inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør YarpNeuro-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for YarpNeuro",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan YarpNeuro ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description":
    "Velg om YarpNeuro skal følge systeminnstillingen eller bruke lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass temaet i YarpNeuro.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når YarpNeuro starter",
  ...
  "settings.updates.toast.latest.title": "YarpNeuro er oppdatert",
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av YarpNeuro.",
  ...
  "wsl.onboarding.checkingOpencode": "Sjekker YarpNeuro...",
  "wsl.onboarding.checkingOpencodeIn": "Sjekker YarpNeuro i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Oppdaterer YarpNeuro...",
  "wsl.onboarding.updatingOpencodeIn": "Oppdaterer YarpNeuro i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Oppdater YarpNeuro i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Oppdater YarpNeuro",
  "wsl.onboarding.opencodeReadyIn": "YarpNeuro er klar i {{distro}}.",
  "wsl.onboarding.opencodeReady": "YarpNeuro er klar.",
  "wsl.onboarding.installOpencodeIn": "Installer YarpNeuro i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "YarpNeuro er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før YarpNeuro kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "YarpNeuro kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter YarpNeuro på nytt.",
  ...
  "help.tabs.introduction": "YarpNeuro Desktop er nå bygget rundt faner.",
  "help.tabs.sessions":
