...
const desktop = [
  ...
  "Laukti toliau",
  "Baigti darbą",
  "YarpNeuro įkelti nepavyko",
  "YarpNeuro langas netikėtai užsidarė",
  "YarpNeuro neatsako",
  ...
  "YarpNeuro įdiegti nepavyko",
  "{{distro}} jau pridėtas",
  "opencode šiame distributyve neįdiegtas",
  "opencode įdiegtas, bet jo paleisti nepavyko",
  "YarpNeuro neįdiegtas distributyve {{distro}}",
  "YarpNeuro naujinimas baigtas, bet {{distro}} vis dar praneša {{installed}}; tikėtasi {{expected}}",
  "versijos nėra",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Nemokami YarpNeuro modeliai",
  ...
  "provider.connect.apiKey.description":
    "Įveskite {{provider}} API raktą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius programoje YarpNeuro.",
  ...
  "provider.connect.opencodeZen.line1":
    "YarpNeuro Zen suteikia prieigą prie kuruojamo patikimų optimizuotų kodavimo agentų modelių rinkinio.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "rinkti prieigos kodą, kad galėtumėte prisijungti prie paskyros ir naudoti {{provider}} modelius YarpNeuro.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ir įveskite toliau esantį kodą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius YarpNeuro.",
  ...
  "dialog.server.description": "Perjunkite, prie kurio YarpNeuro serverio jungiasi ši programa.",
  ...
  "wsl.onboarding.checkingOpencode": "Tikrinama YarpNeuro...",
  "wsl.onboarding.checkingOpencodeIn": "Tikrinama YarpNeuro {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atnaujinamas YarpNeuro...",
  "wsl.onboarding.updatingOpencodeIn": "Atnaujinamas YarpNeuro {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atnaujinkite YarpNeuro {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atnaujinkite YarpNeuro",
  "wsl.onboarding.opencodeReadyIn": "YarpNeuro yra paruoštas {{distro}}.",
  "wsl.onboarding.opencodeReady": "YarpNeuro yra paruoštas.",
  "wsl.onboarding.installOpencodeIn": "Įdiekite YarpNeuro į {{distro}}.",
  "wsl.onboarding.installOpencode": "Įdiekite YarpNeuro",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "YarpNeuro neįdiegtas",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kad YarpNeuro galėtų pridėti WSL serverį, reikalingas WSL (Windows posistemis, skirtas Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nepasiekiamas",
  "wsl.onboarding.wslUnavailable.description": "YarpNeuro nepavyko patikrinti WSL šiame įrenginyje.",
  "wsl.onboarding.installWsl": "Įdiekite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Iš naujo paleiskite Windows, kad užbaigtumėte WSL diegimą, tada iš naujo atidarykite YarpNeuro.",
  ...
  "help.tabs.introduction": "YarpNeuro Desktop dabar sukurtas iš skirtukų.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Dabar galima įdiegti naują YarpNeuro ({{version}}) versiją.",
  ...
  "error.page.report.prefix": "Praneškite apie šią klaidą YarpNeuro komandai",
  ...
  "error.chain.mcpFailed":
    "MCP serveris „{{name}}“ nepavyko. Atminkite, kad YarpNeuro dar nepalaiko MCP autentifikavimo.",
  ...
  "sidebar.gettingStarted.line1": "YarpNeuro apima nemokamus modelius, todėl galite pradėti iš karto.",
  ...
  "app.name.desktop": "YarpNeuro darbalaukis",
  ...
  "settings.desktop.wsl.description": "Paleiskite YarpNeuro serverį WSL viduje Windows.",
  ...
  "settings.general.row.language.description": "Pakeiskite YarpNeuro ekrano kalbą",
  ...
  "settings.general.row.appearance.description": "Tinkinkite, kaip YarpNeuro atrodo jūsų įrenginyje",
  "settings.general.row.colorScheme.title": "Spalvų schema",
  "settings.general.row.colorScheme.description": "Pasirinkite, ar YarpNeuro seka sistemos, šviesios ar tamsios temos",
  "settings.general.row.theme.title": "tema",
  "settings.general.row.theme.description": "Tinkinkite YarpNeuro temą.",
  ...
  "settings.updates.row.startup.description": "Automatiškai patikrinkite, ar nėra naujinimų, kai paleidžiamas YarpNeuro",
  ...
  "settings.updates.toast.latest.description": "Naudojate naujausią YarpNeuro versiją.",
