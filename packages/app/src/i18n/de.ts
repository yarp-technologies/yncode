...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von YarpNeuro",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren API-Schlüssel für {{provider}} ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in YarpNeuro zu nutzen.",
  ...
  "provider.connect.opencodeZen.line1":
    "YarpNeuro Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}}-Modelle in YarpNeuro zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in YarpNeuro zu nutzen.",
  ...
  "dialog.server.description": "Wechseln Sie den YarpNeuro-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.step.opencode": "YarpNeuro",
  ...
  "wsl.onboarding.checkingOpencode": "YarpNeuro wird geprüft…",
  "wsl.onboarding.checkingOpencodeIn": "YarpNeuro in {{distro}} wird geprüft…",
  "wsl.onboarding.updatingOpencode": "YarpNeuro wird aktualisiert…",
  "wsl.onboarding.updatingOpencodeIn": "YarpNeuro in {{distro}} wird aktualisiert…",
  "wsl.onboarding.updateOpencodeIn": "Aktualisieren Sie YarpNeuro in {{distro}}.",
  "wsl.onboarding.updateOpencode": "YarpNeuro aktualisieren",
  "wsl.onboarding.opencodeReadyIn": "YarpNeuro ist in {{distro}} bereit.",
  "wsl.onboarding.opencodeReady": "YarpNeuro ist bereit.",
  "wsl.onboarding.installOpencodeIn": "Installieren Sie YarpNeuro in {{distro}}.",
  "wsl.onboarding.installOpencode": "YarpNeuro installieren",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "YarpNeuro nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor YarpNeuro einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "YarpNeuro konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann YarpNeuro erneut.",
  ...
  "toast.update.description": "Eine neue Version von YarpNeuro ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem YarpNeuro-Team",
  ...
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: YarpNeuro unterstützt noch keine MCP-Authentifizierung.',
  ...
  "home.providerTip":
    "YarpNeuro mit über 75 Anbietern verbinden, um weitere Modelle wie Claude, GPT, Gemini und andere zu nutzen",
  ...
  "sidebar.gettingStarted.line1": "YarpNeuro enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "app.name.desktop": "YarpNeuro Desktop",
  ...
  "settings.desktop.wsl.description": "YarpNeuro-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für YarpNeuro ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie YarpNeuro auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob YarpNeuro dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von YarpNeuro anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von YarpNeuro automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.title": "YarpNeuro ist auf dem neuesten Stand",
  "settings.updates.toast.latest.description": "Die aktuelle Version von YarpNeuro wird verwendet.",
  ...
  "desktop.recovery.loadFailed": "YarpNeuro konnte nicht geladen werden",
  "desktop.recovery.terminated": "Das YarpNeuro-Fenster wurde unerwartet beendet",
  "desktop.recovery.unresponsive": "YarpNeuro reagiert nicht",
  ...
  "desktop.wsl.error.installOpencode": "YarpNeuro-Installation fehlgeschlagen",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "YarpNeuro ist in {{distro}} nicht installiert",
  "desktop.wsl.error.updateVersion":
    "Das YarpNeuro-Update wurde abgeschlossen, aber {{distro}} meldet weiterhin {{installed}}; erwartet wurde {{expected}}",
  ...
  "help.tabs.introduction": "YarpNeuro Desktop basiert jetzt auf Tabs.",
  "help.tabs.sessions":
