export const dict = {
  ...
  "desktop.recovery.loadFailed": "YarpNeuro laadimine ebaõnnestus",
  "desktop.recovery.terminated": "YarpNeuro aken suleti ootamatult",
  "desktop.recovery.unresponsive": "YarpNeuro ei vasta",
  ...
  "desktop.wsl.error.installOpencode": "YarpNeuro installimine ebaõnnestus",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "YarpNeuro pole installitud asukohta {{distro}}",
  "desktop.wsl.error.updateVersion":
    "YarpNeuro värskendus on lõpetatud, kuid {{distro}} teatab endiselt {{installed}}; oodata {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Tasuta mudeleid pakub YarpNeuro",
  ...
  "provider.connect.apiKey.description":
    "Sisestage {{provider}} API võti, et ühendada konto ja kasutada {{provider}} mudeleid YarpNeuro'is.",
  ...
  "provider.connect.opencodeZen.line1":
    "YarpNeuro Zen annab teile juurdepääsu kodeerimisagentide usaldusväärsete optimeeritud mudelite kureeritud komplektile.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " konto ühendamiseks autoriseerimiskoodi kogumiseks ja {{provider}} mudeli kasutamiseks jaotises YarpNeuro.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja sisestage allolev kood, et ühendada oma konto ja kasutada {{provider}} mudelit jaotises YarpNeuro.",
  ...
  "dialog.server.description": "Lülitage, millise YarpNeuro serveriga see rakendus ühenduse loob.",
  ...
  "wsl.onboarding.checkingOpencode": "YarpNeuro kontrollimine...",
  "wsl.onboarding.checkingOpencodeIn": "YarpNeuro kontrollimine asukohas {{distro}}...",
  "wsl.onboarding.updatingOpencode": "YarpNeuro värskendamine...",
  "wsl.onboarding.updatingOpencodeIn": "YarpNeuro värskendamine asukohas {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Värskenda YarpNeuro jaotises {{distro}}.",
  "wsl.onboarding.updateOpencode": "Värskenda YarpNeuro",
  "wsl.onboarding.opencodeReadyIn": "YarpNeuro on valmis {{distro}}.",
  "wsl.onboarding.opencodeReady": "YarpNeuro on valmis.",
  "wsl.onboarding.installOpencodeIn": "Installige YarpNeuro asukohta {{distro}}.",
  "wsl.onboarding.installOpencode": "Installige YarpNeuro",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "YarpNeuro pole installitud",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows alamsüsteem Linux jaoks) on nõutav, enne kui YarpNeuro saab lisada WSL serveri",
  "wsl.onboarding.wslUnavailable.title": "WSL pole saadaval",
  "wsl.onboarding.wslUnavailable.description": "YarpNeuro ei saanud selles masinas kontrollida WSL.",
  "wsl.onboarding.installWsl": "Installige WSL",
  "wsl.onboarding.windowsRestartRequired": "Taaskäivitage Windows, et installida WSL, seejärel avage uuesti YarpNeuro.",
  ...
  "help.tabs.introduction": "YarpNeuro Töölaud on nüüd üles ehitatud vahekaartide ümber.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Rakenduse YarpNeuro ({{version}}) uus versioon on nüüd installimiseks saadaval.",
  ...
  "error.page.report.prefix": "Teatage sellest veast YarpNeuro meeskonnale",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" ebaõnnestus. Pange tähele, YarpNeuro ei toeta veel MCP autentimist.',
  ...
  "sidebar.gettingStarted.line1": "YarpNeuro sisaldab tasuta mudeleid, nii et saate kohe alustada.",
  ...
  "app.name.desktop": "YarpNeuro Töölaud",
  ...
  "settings.desktop.wsl.description": "Käivitage YarpNeuro server sees WSL saidil Windows.",
  ...
  "settings.general.row.language.description": "Muutke YarpNeuro kuvakeelt",
  ...
  "settings.general.row.appearance.description": "Kohandage, kuidas YarpNeuro teie seadmes välja näeb",
  "settings.general.row.colorScheme.title": "Värvilahendus",
  "settings.general.row.colorScheme.description": "Valige, kas YarpNeuro järgib süsteemi, heledat või tumedat teemat",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Kohandage, kuidas YarpNeuro on teemastatud.",
  ...
  "settings.updates.row.startup.description": "Kontrollige automaatselt värskendusi, kui YarpNeuro käivitub",
  ...
  "settings.updates.toast.latest.description": "Kasutate rakenduse YarpNeuro uusimat versiooni.",
