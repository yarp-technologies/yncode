export const dict = {
  ...
  "desktop.recovery.loadFailed": "فشل تحميل YarpNeuro",
  "desktop.recovery.terminated": "توقفت نافذة YarpNeuro بشكل غير متوقع",
  "desktop.recovery.unresponsive": "YarpNeuro لا يستجيب",
  ...
  "desktop.wsl.error.installOpencode": "فشل تثبيت YarpNeuro",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "YarpNeuro غير مثبت في {{distro}}",
  "desktop.wsl.error.updateVersion":
    "اكتمل تحديث YarpNeuro، لكن {{distro}} ما زالت تعرض الإصدار {{installed}}؛ الإصدار المتوقع هو {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من YarpNeuro",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح API الخاص بـ {{provider}} لتوصيل حسابك واستخدام نماذج {{provider}} في YarpNeuro.",
  ...
  "provider.connect.opencodeZen.line1":
    "يمنحك YarpNeuro Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في YarpNeuro.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في YarpNeuro.",
  ...
  "dialog.server.description": "تبديل خادم YarpNeuro الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingOpencode": "جارٍ التحقق من YarpNeuro...",
  "wsl.onboarding.checkingOpencodeIn": "جارٍ التحقق من YarpNeuro في {{distro}}...",
  "wsl.onboarding.updatingOpencode": "جارٍ تحديث YarpNeuro...",
  "wsl.onboarding.updatingOpencodeIn": "جارٍ تحديث YarpNeuro في {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "حدّث YarpNeuro في {{distro}}.",
  "wsl.onboarding.updateOpencode": "تحديث YarpNeuro",
  "wsl.onboarding.opencodeReadyIn": "YarpNeuro جاهز في {{distro}}.",
  "wsl.onboarding.opencodeReady": "YarpNeuro جاهز.",
  "wsl.onboarding.installOpencodeIn": "ثبّت YarpNeuro في {{distro}}.",
  "wsl.onboarding.installOpencode": "تثبيت YarpNeuro",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "YarpNeuro غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن YarpNeuro من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على YarpNeuro التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح YarpNeuro.",
  ...
  "help.tabs.introduction": "أصبح YarpNeuro Desktop الآن قائمًا على علامات التبويب.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "يتوفر الآن إصدار جديد من YarpNeuro ({{version}}) للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق YarpNeuro",
  ...
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن YarpNeuro لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن YarpNeuro نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم YarpNeuro داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ YarpNeuro",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور YarpNeuro على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان YarpNeuro يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة YarpNeuro.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل YarpNeuro",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من YarpNeuro.",
