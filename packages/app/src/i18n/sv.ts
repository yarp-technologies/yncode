export const dict = {
  ...
  "desktop.recovery.loadFailed": "YarpNeuro kunde inte läsas in",
  "desktop.recovery.terminated": "YarpNeuro-fönstret avslutades oväntat",
  "desktop.recovery.unresponsive": "YarpNeuro svarar inte",
  ...
  "desktop.wsl.error.installOpencode": "Installationen av YarpNeuro misslyckades",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "YarpNeuro är inte installerat i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "YarpNeuro-uppdateringen slutfördes, men {{distro}} rapporterar fortfarande {{installed}}. {{expected}} förväntades",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller tillhandahålls av YarpNeuro",
  ...
  "provider.connect.apiKey.description":
    "Ange din {{provider}}-API-nyckel för att ansluta ditt konto och använda {{provider}}-modeller i YarpNeuro.",
  ...
  "provider.connect.opencodeZen.line1":
    "YarpNeuro Zen ger dig tillgång till en utvald uppsättning pålitliga optimerade modeller för kodningsagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " för att hämta auktoriseringskoden som ansluter ditt konto och låter dig använda {{provider}}-modeller i YarpNeuro.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " och ange koden nedan för att ansluta ditt konto och använda {{provider}}-modeller i YarpNeuro.",
  ...
  "dialog.server.description": "Växla vilken YarpNeuro-server som denna app ansluter till.",
  ...
  "wsl.onboarding.checkingOpencode": "Kontrollerar YarpNeuro...",
  "wsl.onboarding.checkingOpencodeIn": "Kontrollerar YarpNeuro i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Uppdaterar YarpNeuro...",
  "wsl.onboarding.updatingOpencodeIn": "Uppdaterar YarpNeuro i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Uppdatera YarpNeuro i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Uppdatera YarpNeuro",
  "wsl.onboarding.opencodeReadyIn": "YarpNeuro är redo i {{distro}}.",
  "wsl.onboarding.opencodeReady": "YarpNeuro är redo.",
  "wsl.onboarding.installOpencodeIn": "Installera YarpNeuro i {{distro}}.",
  "wsl.onboarding.installOpencode": "Installera YarpNeuro",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "YarpNeuro är inte installerat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) krävs innan YarpNeuro kan lägga till en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL är inte tillgängligt",
  "wsl.onboarding.wslUnavailable.description": "YarpNeuro kunde inte verifiera WSL på den här maskinen.",
  "wsl.onboarding.installWsl": "Installera WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Starta om Windows för att slutföra installationen av WSL och öppna sedan YarpNeuro igen.",
  ...
  "help.tabs.introduction": "YarpNeuro Desktop är nu uppbyggt kring flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "En ny version av YarpNeuro ({{version}}) är nu tillgänglig att installera.",
  ...
  "error.page.report.prefix": "Rapportera det här felet till YarpNeuro-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-servern "{{name}}" misslyckades. Obs, YarpNeuro stöder inte MCP-autentisering ännu.',
  ...
  "sidebar.gettingStarted.line1": "YarpNeuro innehåller gratis modeller så att du kan börja direkt.",
  ...
  "settings.desktop.wsl.description": "Kör YarpNeuro-servern inuti WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ändra visningsspråket för YarpNeuro",
  ...
  "settings.general.row.appearance.description": "Anpassa hur YarpNeuro ser ut på din enhet",
  "settings.general.row.colorScheme.title": "Färgschema",
  "settings.general.row.colorScheme.description": "Välj om YarpNeuro följer system-, ljus- eller mörktemat",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Anpassa YarpNeuros tema.",
  ...
  "settings.updates.row.startup.description": "Sök automatiskt efter uppdateringar när YarpNeuro startas",
  ...
  "settings.updates.toast.latest.description": "Du kör den senaste versionen av YarpNeuro.",
