export const dict = {
  ...
  "desktop.recovery.loadFailed": "YarpNeuro መጫን አልቻለም",
  "desktop.recovery.terminated": "YarpNeuro መስኮት በድንገት ተቋርጧል",
  "desktop.recovery.unresponsive": "YarpNeuro ምላሽ እየሰጠ አይደለም",
  ...
  "desktop.wsl.error.installOpencode": "YarpNeuroመጫኑ አልተሳካም",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "YarpNeuro በ{{distro}}] ውስጥ አልተጫነም",
  "desktop.wsl.error.updateVersion":
    "YarpNeuro ዝማኔ አልቋል ግን {{distro}} አሁንም ሪፖርት ያደርጋል {{installed}}; የሚጠበቀው {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "ነጻ ሞዴሎች በYarpNeuro",
  ...
  "provider.connect.apiKey.description":
    "መለያዎን ለማገናኘት የ{{provider}} API ቁልፍዎን ያስገቡ እና {{provider}} ሞዴሎችን በYarpNeuro ይጠቀሙ።",
  ...
  "provider.connect.opencodeZen.line1": "YarpNeuro ዜን ለኮድ ወኪሎች የተመቻቹ አስተማማኝ ሞዴሎች ስብስብ መዳረሻ ይሰጥዎታል።",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " መለያዎን ለማገናኘት የፈቀዳ ኮድዎን ለመሰብሰብ እና {{provider}} ሞዴሎችን በYarpNeuro ውስጥ ይጠቀሙ።",
  ...
  "provider.connect.oauth.auto.visit.suffix": " እና መለያዎን ለማገናኘት ከታች ያለውን ኮድ ያስገቡ እና {{provider}} ሞዴሎችን በYarpNeuro ይጠቀሙ።",
  ...
  "dialog.server.description": "ይህ መተግበሪያ ከየትኛው YarpNeuro አገልጋይ ጋር እንደሚገናኝ ይቀይሩ።",
  ...
  "wsl.onboarding.checkingOpencode": "መፈተሽ YarpNeuro...",
  "wsl.onboarding.checkingOpencodeIn": "YarpNeuroን በ{{distro}} ውስጥ በመፈተሽ ላይ...",
  "wsl.onboarding.updatingOpencode": "በማዘመን ላይ YarpNeuro...",
  "wsl.onboarding.updatingOpencodeIn": "በማዘመን ላይ YarpNeuro በ{{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "አዘምን YarpNeuro በ{{distro}}።",
  "wsl.onboarding.updateOpencode": "አዘምን YarpNeuro",
  "wsl.onboarding.opencodeReadyIn": "YarpNeuro በ{{distro}} ውስጥ ዝግጁ ነው።",
  "wsl.onboarding.opencodeReady": "YarpNeuro ዝግጁ ነው።",
  "wsl.onboarding.installOpencodeIn": "መጫን YarpNeuro በ{{distro}} ውስጥ።",
  "wsl.onboarding.installOpencode": "ጫን YarpNeuro",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "YarpNeuroአልተጫነም",
  ...
  "wsl.onboarding.wslNotInstalled.description": "WSL (Windowsንዑስ ስርዓት ለLinux) YarpNeuro WSL አገልጋይ ከመጨመራቸው በፊት ያስፈልጋል",
  "wsl.onboarding.wslUnavailable.title": "WSL አይገኝም",
  "wsl.onboarding.wslUnavailable.description": "YarpNeuro በዚህ ማሽን ላይ WSLን ማረጋገጥ አልቻለም።",
  "wsl.onboarding.installWsl": "ጫን WSL",
  "wsl.onboarding.windowsRestartRequired": "WSLን መጫኑን ለመጨረስ Windows እንደገና ያስጀምሩ እና ከዚያ እንደገና ይክፈቱ YarpNeuro።",
  ...
  "help.tabs.introduction": "YarpNeuro ዴስክቶፕ አሁን በትሮች ዙሪያ ነው የተሰራው።",
  "help.tabs.sessions":
  ...
  "toast.update.description": "አዲሱ የYarpNeuro ({{version}}) ስሪት አሁን ለመጫን አለ።",
  ...
  "error.page.report.prefix": "እባክዎ ይህንን ስህተት ለYarpNeuro ቡድን ያሳውቁ",
  ...
  "error.chain.mcpFailed": 'MCP አገልጋይ "{{name}}" አልተሳካም። ማስታወሻ፣ YarpNeuro እስካሁን MCP ማረጋገጫን አይደግፍም።',
  ...
  "sidebar.gettingStarted.line1": "YarpNeuro ነፃ ሞዴሎችን ያካትታል ስለዚህ ወዲያውኑ መጀመር ይችላሉ።",
  ...
  "app.name.desktop": "YarpNeuro ዴስክቶፕ",
  ...
  "settings.desktop.wsl.description": "የYarpNeuro አገልጋዩን በWSL ውስጥ በWindows ላይ ያሂዱ።",
  ...
  "settings.general.row.language.description": "የማሳያ ቋንቋውን ለYarpNeuro",
  ...
  "settings.general.row.appearance.description": "YarpNeuroበመሣሪያዎ ላይ እንዴት እንደሚታይ ብጁ ያድርጉ",
  "settings.general.row.colorScheme.title": "የቀለም ንድፍ",
  "settings.general.row.colorScheme.description": "YarpNeuro ስርዓቱን፣ ብርሃንን ወይም ጨለማውን ገጽታ የሚከተል እንደሆነ ምረጥ",
  "settings.general.row.theme.title": "ገጽታ",
  "settings.general.row.theme.description": "YarpNeuro ገጽታ እንዴት እንደሆነ አብጅ።",
  ...
  "settings.updates.row.startup.description": "YarpNeuro ሲጀመር ዝማኔዎችን በራስ-ሰር ያረጋግጡ",
  ...
  "settings.updates.toast.latest.description": "የቅርብ ጊዜውን የYarpNeuro እትም እያሄዱ ነው።",
