...
const desktop = [
  ...
  "Nastavi čekati",
  "Izađi",
  "YarpNeuro se nije uspio učitati",
  "Prozor aplikacije YarpNeuro neočekivano je zatvoren",
  "YarpNeuro ne reagira",
  ...
  "Instalacija aplikacije YarpNeuro nije uspjela",
  ...
  "YarpNeuro nije instaliran u distribuciji {{distro}}",
  "Ažuriranje aplikacije YarpNeuro je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  "nema verzije",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatne modele nudi YarpNeuro",
  ...
  "provider.connect.apiKey.description":
    "Enter vaš {{provider}} API ključ za povezivanje vašeg računa i korištenje {{provider}} modela u YarpNeuro.",
  ...
  "provider.connect.opencodeZen.line1":
    "YarpNeuro Zen vam daje pristup odabranom skupu pouzdanih optimiziranih modela za agente za kodiranje.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "za prikupljanje vašeg autorizacijskog koda za povezivanje vašeg računa i korištenje {{provider}} modela u YarpNeuro.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "i unesite kod ispod kako biste povezali svoj račun i koristili {{provider}} modele u YarpNeuro.",
  ...
  "dialog.server.description": "Promijenite na koji se YarpNeuro poslužitelj povezuje ova aplikacija.",
  ...
  "wsl.onboarding.checkingOpencodeIn": "Provjera YarpNeuro u {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje YarpNeuro...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje YarpNeuro u {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažurirajte YarpNeuro u {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažurirajte YarpNeuro",
  "wsl.onboarding.opencodeReadyIn": "YarpNeuro je spreman u {{distro}}.",
  "wsl.onboarding.opencodeReady": "YarpNeuro je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instalirajte YarpNeuro u {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalirajte YarpNeuro",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows podsustav za Linux) je potreban prije nego što YarpNeuro može dodati WSL poslužitelj",
  "wsl.onboarding.wslUnavailable.title": "WSL nedostupan",
  "wsl.onboarding.wslUnavailable.description": "YarpNeuro nije mogao potvrditi WSL na ovom stroju.",
  "wsl.onboarding.installWsl": "Instalirajte WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokrenite Windows da dovršite instalaciju WSL, zatim ponovno otvorite YarpNeuro.",
  ...
  "help.tabs.introduction": "Radna površina YarpNeuro sada je izgrađena oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija YarpNeuro ({{version}}) sada je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Prijavite ovu grešku YarpNeuro timu",
  ...
  "error.chain.mcpFailed":
    'MCP poslužitelj "{{name}}" nije uspio. Napomena, YarpNeuro još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "YarpNeuro uključuje besplatne modele tako da možete odmah početi.",
  ...
  "app.name.desktop": "YarpNeuro Radna površina",
  ...
  "settings.desktop.wsl.description": "Pokrenite YarpNeuro poslužitelj unutar WSL na Windows.",
  ...
  "settings.general.row.language.description": "Promijenite jezik prikaza za YarpNeuro",
  ...
  "settings.general.row.appearance.description": "Prilagodite kako YarpNeuro izgleda na vašem uređaju",
  "settings.general.row.colorScheme.title": "Shema boja",
  "settings.general.row.colorScheme.description":
    "Odaberite hoće li YarpNeuro slijediti sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite način na koji je YarpNeuro tematiziran.",
  ...
  "settings.updates.row.startup.description": "Automatski provjeri ima li ažuriranja kada se YarpNeuro pokrene",
  ...
  "settings.updates.toast.latest.description": "Imate najnoviju verziju YarpNeuro.",
