export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "YarpNeuron tarjoamat ilmaiset mallit",
  ...
  "provider.connect.apiKey.description":
    "Anna {{provider}}-API-avaimesi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja YarpNeurossa.",
  ...
  "provider.connect.opencodeZen.line1":
    "YarpNeuro Zen antaa sinulle pääsyn kuratoituun joukkoon luotettavia optimoituja malleja koodausagenteille.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " ja hae valtuutuskoodi, jolla voit yhdistää tilisi ja käyttää {{provider}}-malleja YarpNeurossa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja anna alla oleva koodi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja YarpNeurossa.",
  ...
  "dialog.server.description": "Vaihda YarpNeuro-palvelimeen, johon tämä sovellus muodostaa yhteyden.",
  ...
  "wsl.onboarding.checkingOpencode": "Tarkistetaan YarpNeuroa...",
  "wsl.onboarding.checkingOpencodeIn": "Tarkistetaan YarpNeuroa kohteessa {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Päivitetään YarpNeuroa...",
  "wsl.onboarding.updatingOpencodeIn": "Päivitetään YarpNeuroa kohteessa {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Päivitä YarpNeuro jakelussa {{distro}}.",
  "wsl.onboarding.updateOpencode": "Päivitä YarpNeuro",
  "wsl.onboarding.opencodeReadyIn": "YarpNeuro on valmis jakelussa {{distro}}.",
  "wsl.onboarding.opencodeReady": "YarpNeuro on valmis.",
  "wsl.onboarding.installOpencodeIn": "Asenna YarpNeuro jakeluun {{distro}}.",
  "wsl.onboarding.installOpencode": "Asenna YarpNeuro",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "YarpNeuroa ei ole asennettu",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) vaaditaan ennen kuin YarpNeuro voi lisätä WSL-palvelimen",
  "wsl.onboarding.wslUnavailable.title": "WSL ei ole käytettävissä",
  "wsl.onboarding.wslUnavailable.description": "YarpNeuro ei voinut vahvistaa WSL:ää tällä koneella.",
  "wsl.onboarding.installWsl": "Asenna WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Viimeistele WSL:n asennus käynnistämällä Windows uudelleen ja avaa sitten YarpNeuro uudelleen.",
  ...
  "toast.update.description": "YarpNeuron uusi versio ({{version}}) on nyt saatavana asennettavaksi.",
  ...
  "error.page.report.prefix": "Ilmoita tästä virheestä YarpNeuro-tiimille",
  ...
  "error.chain.mcpFailed": 'MCP-palvelin "{{name}}" epäonnistui. Huomaa, että YarpNeuro ei vielä tue MCP-todennusta.',
  ...
  "sidebar.gettingStarted.line1": "YarpNeuro sisältää ilmaisia malleja, joten voit aloittaa heti.",
  ...
  "settings.desktop.wsl.description": "Suorita YarpNeuro-palvelin WSL:n sisällä Windowsissa.",
  ...
  "settings.general.row.language.description": "Vaihda YarpNeuron näyttökieli",
  ...
  "settings.general.row.appearance.description": "Mukauta, miltä YarpNeuro näyttää laitteellasi",
  "settings.general.row.colorScheme.title": "Värimalli",
  "settings.general.row.colorScheme.description":
    "Valitse, käyttääkö YarpNeuro järjestelmän mukaista, vaaleaa vai tummaa teemaa",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Mukauta YarpNeuron teemaa.",
  ...
  "settings.updates.row.startup.description": "Tarkista päivitykset automaattisesti, kun YarpNeuro käynnistyy",
  ...
  "settings.updates.toast.latest.description": "Käytät YarpNeuron uusinta versiota.",
  ...
  "desktop.menu.documentation": "YarpNeuro-dokumentaatio",
  ...
  "desktop.menu.ariaLabel": "YarpNeuro-valikko",
  ...
  "desktop.recovery.loadFailed": "YarpNeuron lataaminen epäonnistui",
  "desktop.recovery.terminated": "YarpNeuro-ikkuna sulkeutui odottamatta",
  "desktop.recovery.unresponsive": "YarpNeuro ei vastaa",
  ...
  "desktop.wsl.error.installOpencode": "YarpNeuron asennus epäonnistui",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "YarpNeuroa ei ole asennettu jakeluun {{distro}}",
  "desktop.wsl.error.updateVersion":
    "YarpNeuron päivitys valmistui, mutta {{distro}} ilmoittaa yhä version {{installed}}; odotettu versio on {{expected}}",
  ...
  "help.tabs.introduction": "YarpNeuro Desktop perustuu nyt välilehtiin.",
  "help.tabs.sessions":
