export const dict = {
  ...
  "desktop.recovery.loadFailed": "YarpNeuro gagal dimuat",
  "desktop.recovery.terminated": "Jendela YarpNeuro berhenti secara tidak terduga",
  "desktop.recovery.unresponsive": "YarpNeuro tidak merespons",
  ...
  "desktop.wsl.error.installOpencode": "Instalasi YarpNeuro gagal",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "YarpNeuro belum terinstal di {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Pembaruan YarpNeuro selesai, tetapi {{distro}} masih melaporkan {{installed}}; seharusnya {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Model gratis disediakan oleh YarpNeuro",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} untuk menghubungkan akun Anda dan gunakan model {{provider}} di YarpNeuro.",
  ...
  "provider.connect.opencodeZen.line1":
    "YarpNeuro Zen memberi Anda akses ke serangkaian model andal yang dioptimalkan untuk agen pengodean.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kode otorisasi guna menghubungkan akun Anda dan menggunakan model {{provider}} di YarpNeuro.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kode di bawah untuk menghubungkan akun dan menggunakan model {{provider}} di YarpNeuro.",
  ...
  "dialog.server.description": "Ganti server YarpNeuro mana yang terhubung dengan aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Memeriksa YarpNeuro...",
  "wsl.onboarding.checkingOpencodeIn": "Memeriksa YarpNeuro di {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Memperbarui YarpNeuro...",
  "wsl.onboarding.updatingOpencodeIn": "Memperbarui YarpNeuro di {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Perbarui YarpNeuro di {{distro}}.",
  "wsl.onboarding.updateOpencode": "Perbarui YarpNeuro",
  "wsl.onboarding.opencodeReadyIn": "YarpNeuro siap di {{distro}}.",
  "wsl.onboarding.opencodeReady": "YarpNeuro siap.",
  "wsl.onboarding.installOpencodeIn": "Instal YarpNeuro di {{distro}}.",
  "wsl.onboarding.installOpencode": "Instal YarpNeuro",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "YarpNeuro belum terinstal",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum YarpNeuro dapat menambahkan server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "YarpNeuro tidak dapat memverifikasi WSL di komputer ini.",
  "wsl.onboarding.installWsl": "Instal WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulai ulang Windows untuk menyelesaikan instalasi WSL, lalu buka kembali YarpNeuro.",
  ...
  "help.tabs.introduction": "YarpNeuro Desktop kini dirancang dengan tab sebagai pusatnya.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baru YarpNeuro ({{version}}) sekarang tersedia untuk diinstal.",
  ...
  "error.page.report.prefix": "Harap laporkan kesalahan ini ke tim YarpNeuro",
  ...
  "error.chain.mcpFailed": 'Server MCP "{{name}}" gagal. Catatan: YarpNeuro belum mendukung autentikasi MCP.',
  ...
  "sidebar.gettingStarted.line1": "YarpNeuro menyertakan model gratis sehingga Anda dapat memulai dengan segera.",
  ...
  "settings.desktop.wsl.description": "Jalankan server YarpNeuro di dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Ubah bahasa tampilan untuk YarpNeuro",
  ...
  "settings.general.row.appearance.description": "Sesuaikan tampilan YarpNeuro di perangkat Anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih apakah YarpNeuro mengikuti tema sistem, terang, atau gelap",
  ...
  "settings.updates.row.startup.description": "Secara otomatis memeriksa pembaruan saat YarpNeuro diluncurkan",
  ...
  "settings.updates.toast.latest.description": "Anda menjalankan versi terbaru YarpNeuro.",
