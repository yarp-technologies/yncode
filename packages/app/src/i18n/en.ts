...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by YarpNeuro",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in YarpNeuro.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.opencodeZen.line1":
    "YarpNeuro Zen gives you access to a curated set of reliable optimized models for coding agents.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in YarpNeuro.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in YarpNeuro.",
  ...
  "dialog.server.description": "Switch which YarpNeuro server this app connects to.",
  ...
  "wsl.onboarding.checkingOpencode": "Checking YarpNeuro...",
  "wsl.onboarding.checkingOpencodeIn": "Checking YarpNeuro in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating YarpNeuro...",
  "wsl.onboarding.updatingOpencodeIn": "Updating YarpNeuro in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update YarpNeuro in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update YarpNeuro",
  "wsl.onboarding.opencodeReadyIn": "YarpNeuro is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "YarpNeuro is ready.",
  "wsl.onboarding.installOpencodeIn": "Install YarpNeuro in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install YarpNeuro",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "YarpNeuro not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before YarpNeuro can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "YarpNeuro could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen YarpNeuro.",
  ...
  "help.tabs.introduction": "YarpNeuro Desktop is now built around tabs.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A new version of YarpNeuro ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the YarpNeuro team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, YarpNeuro does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "YarpNeuro includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the YarpNeuro server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for YarpNeuro",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how YarpNeuro looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether YarpNeuro follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how YarpNeuro is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when YarpNeuro launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of YarpNeuro.",
