export const dict = {
  ...
  "desktop.menu.documentation": "Documentation d'YarpNeuro",
  ...
  "desktop.recovery.loadFailed": "Échec du chargement d'YarpNeuro",
  "desktop.recovery.terminated": "La fenêtre YarpNeuro s'est arrêtée de manière inattendue",
  "desktop.recovery.unresponsive": "YarpNeuro ne répond pas",
  ...
  "desktop.wsl.error.installOpencode": "Échec de l'installation d'YarpNeuro",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "YarpNeuro n'est pas installé dans {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La mise à jour d'YarpNeuro est terminée, mais {{distro}} indique toujours {{installed}} au lieu de {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par YarpNeuro",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans YarpNeuro.",
  ...
  "provider.connect.opencodeZen.line1":
    "YarpNeuro Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans YarpNeuro.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans YarpNeuro.",
  ...
  "dialog.server.description": "Changez le serveur YarpNeuro auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingOpencode": "Vérification d'YarpNeuro...",
  "wsl.onboarding.checkingOpencodeIn": "Vérification d'YarpNeuro dans {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Mise à jour d'YarpNeuro...",
  "wsl.onboarding.updatingOpencodeIn": "Mise à jour d'YarpNeuro dans {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Mettez à jour YarpNeuro dans {{distro}}.",
  "wsl.onboarding.updateOpencode": "Mettre à jour YarpNeuro",
  "wsl.onboarding.opencodeReadyIn": "YarpNeuro est prêt dans {{distro}}.",
  "wsl.onboarding.opencodeReady": "YarpNeuro est prêt.",
  "wsl.onboarding.installOpencodeIn": "Installez YarpNeuro dans {{distro}}.",
  "wsl.onboarding.installOpencode": "Installer YarpNeuro",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "YarpNeuro non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'YarpNeuro puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "YarpNeuro n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez YarpNeuro.",
  ...
  "help.tabs.introduction": "YarpNeuro Desktop s'articule désormais autour d'onglets.",
  "help.tabs.sessions":
  ...
  "toast.update.description":
    "Une nouvelle version d'YarpNeuro ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe YarpNeuro",
  ...
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'YarpNeuro ne prend pas encore en charge l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "YarpNeuro inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur YarpNeuro dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour YarpNeuro",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'YarpNeuro sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si YarpNeuro suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'YarpNeuro.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'YarpNeuro",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'YarpNeuro.",
