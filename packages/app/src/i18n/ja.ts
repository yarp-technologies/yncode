export const dict = {
  ...
  "desktop.recovery.loadFailed": "YarpNeuroを読み込めませんでした",
  "desktop.recovery.terminated": "YarpNeuroのウインドウが予期せず終了しました",
  "desktop.recovery.unresponsive": "YarpNeuroが応答していません",
  ...
  "desktop.wsl.error.installOpencode": "YarpNeuroのインストールに失敗しました",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}}にはYarpNeuroがインストールされていません",
  "desktop.wsl.error.updateVersion":
    "YarpNeuroのアップデートは完了しましたが、{{distro}}から報告されたバージョンはまだ{{installed}}です。想定されるバージョンは{{expected}}です",
  ...
  "dialog.model.unpaid.freeModels.title": "YarpNeuroが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、YarpNeuroで{{provider}}モデルを使用します。",
  ...
  "provider.connect.opencodeZen.line1":
    "YarpNeuro Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してYarpNeuroで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、YarpNeuroで{{provider}}モデルを使用してください。",
  ...
  "dialog.server.description": "このアプリが接続するYarpNeuroサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingOpencode": "YarpNeuroを確認中...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}内のYarpNeuroを確認中...",
  "wsl.onboarding.updatingOpencode": "YarpNeuroを更新中...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}内のYarpNeuroを更新中...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}内のYarpNeuroを更新してください。",
  "wsl.onboarding.updateOpencode": "YarpNeuroを更新",
  "wsl.onboarding.opencodeReadyIn": "{{distro}}内のYarpNeuroの準備ができました。",
  "wsl.onboarding.opencodeReady": "YarpNeuroの準備ができました。",
  "wsl.onboarding.installOpencodeIn": "{{distro}}にYarpNeuroをインストールしてください。",
  "wsl.onboarding.installOpencode": "YarpNeuroをインストール",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "YarpNeuroがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "YarpNeuroでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、YarpNeuroをもう一度開いてください。",
  ...
  "help.tabs.introduction": "YarpNeuro Desktopでタブを中心とした操作ができるようになりました。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "YarpNeuroの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをYarpNeuroチームに報告してください: ",
  ...
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: YarpNeuroはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "YarpNeuroには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でYarpNeuroサーバーを実行します。",
  ...
  "settings.general.row.language.description": "YarpNeuroの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのYarpNeuroの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "YarpNeuroがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "YarpNeuroのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "YarpNeuro の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "YarpNeuro は最新バージョンです。",
