export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentasi YarpNeuro",
  ...
  "desktop.recovery.loadFailed": "YarpNeuro gagal dimuatkan",
  "desktop.recovery.terminated": "Tetingkap YarpNeuro ditamatkan secara tidak dijangka",
  "desktop.recovery.unresponsive": "YarpNeuro tidak memberi respons",
  ...
  "desktop.wsl.error.installOpencode": "Pemasangan YarpNeuro gagal",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "YarpNeuro tidak dipasang dalam {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Kemas kini YarpNeuro selesai tetapi {{distro}} masih melaporkan {{installed}}; sepatutnya {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Model percuma yang disediakan oleh YarpNeuro",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} anda untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam YarpNeuro.",
  ...
  "provider.connect.opencodeZen.line1":
    "YarpNeuro Zen memberi anda akses kepada set model terpilih yang boleh dipercayai dan dioptimumkan untuk ejen pengekodan.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kod kebenaran anda bagi menghubungkan akaun dan menggunakan model {{provider}} dalam YarpNeuro.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kod di bawah untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam YarpNeuro.",
  ...
  "dialog.server.description": "Tukar pelayan YarpNeuro yang disambungkan oleh aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Sedang menyemak YarpNeuro...",
  "wsl.onboarding.checkingOpencodeIn": "Sedang menyemak YarpNeuro dalam {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Sedang mengemas kini YarpNeuro...",
  "wsl.onboarding.updatingOpencodeIn": "Sedang mengemas kini YarpNeuro dalam {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Kemas kini YarpNeuro dalam {{distro}}.",
  "wsl.onboarding.updateOpencode": "Kemas kini YarpNeuro",
  "wsl.onboarding.opencodeReadyIn": "YarpNeuro sedia digunakan dalam {{distro}}.",
  "wsl.onboarding.opencodeReady": "YarpNeuro sedia digunakan.",
  "wsl.onboarding.installOpencodeIn": "Pasang YarpNeuro dalam {{distro}}.",
  "wsl.onboarding.installOpencode": "Pasang YarpNeuro",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "YarpNeuro belum dipasang",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum YarpNeuro boleh menambah pelayan WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "YarpNeuro tidak dapat mengesahkan WSL pada mesin ini.",
  "wsl.onboarding.installWsl": "Pasang WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulakan semula Windows untuk menyiapkan pemasangan WSL, kemudian buka semula YarpNeuro.",
  ...
  "help.tabs.introduction": "YarpNeuro Desktop kini dibina berasaskan tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baharu YarpNeuro ({{version}}) kini tersedia untuk dipasang.",
  ...
  "error.page.report.prefix": "Sila laporkan ralat ini kepada pasukan YarpNeuro",
  ...
  "error.chain.mcpFailed": 'Pelayan MCP "{{name}}" gagal. Nota, YarpNeuro belum menyokong pengesahan MCP.',
  ...
  "sidebar.gettingStarted.line1": "YarpNeuro merangkumi model percuma supaya anda boleh bermula serta-merta.",
  ...
  "settings.desktop.wsl.description": "Jalankan pelayan YarpNeuro dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Tukar bahasa paparan untuk YarpNeuro",
  ...
  "settings.general.row.appearance.description": "Sesuaikan rupa YarpNeuro pada peranti anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih sama ada YarpNeuro mengikut sistem, tema cerah, atau gelap",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Sesuaikan tema YarpNeuro.",
  ...
  "settings.updates.row.startup.description": "Semak kemas kini secara automatik apabila YarpNeuro dilancarkan",
  ...
  "settings.updates.toast.latest.description": "Anda sedang menggunakan versi terkini YarpNeuro.",
