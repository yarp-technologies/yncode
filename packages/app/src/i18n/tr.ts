...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "YarpNeuro yüklenemedi",
  "desktop.recovery.terminated": "YarpNeuro penceresi beklenmedik şekilde sonlandırıldı",
  "desktop.recovery.unresponsive": "YarpNeuro yanıt vermiyor",
  ...
  "desktop.wsl.error.installOpencode": "YarpNeuro kurulamadı",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "YarpNeuro, {{distro}} içinde kurulu değil",
  "desktop.wsl.error.updateVersion":
    "YarpNeuro güncellemesi tamamlandı ancak {{distro}} hâlâ {{installed}} sürümünü bildiriyor; beklenen sürüm: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "YarpNeuro tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve YarpNeuro'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.opencodeZen.line1":
    "YarpNeuro Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak YarpNeuro'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak YarpNeuro'da {{provider}} modellerini kullanın.",
  ...
  "dialog.server.description": "Bu uygulamanın hangi YarpNeuro sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingOpencode": "YarpNeuro kontrol ediliyor...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde YarpNeuro kontrol ediliyor...",
  "wsl.onboarding.updatingOpencode": "YarpNeuro güncelleniyor...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} içinde YarpNeuro güncelleniyor...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} içindeki YarpNeuro'u güncelleyin.",
  "wsl.onboarding.updateOpencode": "YarpNeuro'u güncelle",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} içinde YarpNeuro hazır.",
  "wsl.onboarding.opencodeReady": "YarpNeuro hazır.",
  "wsl.onboarding.installOpencodeIn": "YarpNeuro'u {{distro}} içine kurun.",
  "wsl.onboarding.installOpencode": "YarpNeuro'u kur",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "YarpNeuro kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "YarpNeuro'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "YarpNeuro bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından YarpNeuro'u tekrar açın.",
  ...
  "help.tabs.introduction": "YarpNeuro Desktop artık sekmeler üzerine kurulu.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "YarpNeuro'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı YarpNeuro ekibine",
  ...
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" çalıştırılamadı. Not: YarpNeuro henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "YarpNeuro ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "YarpNeuro Masaüstü",
  ...
  "settings.desktop.wsl.description": "YarpNeuro sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "YarpNeuro'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "YarpNeuro'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "YarpNeuro'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "YarpNeuro'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "YarpNeuro başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "YarpNeuro'un en son sürümünü kullanıyorsunuz.",
