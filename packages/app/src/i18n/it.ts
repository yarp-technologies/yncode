export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelli gratuiti forniti da YarpNeuro",
  ...
  "provider.connect.apiKey.description":
    "Inserisci la chiave API di {{provider}} per connettere il tuo account e utilizzare i modelli {{provider}} in YarpNeuro.",
  ...
  "provider.connect.opencodeZen.line1":
    "YarpNeuro Zen offre l'accesso a una selezione di modelli affidabili e ottimizzati per gli agenti di programmazione.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " per ottenere il codice di autorizzazione, connettere il tuo account e usare i modelli {{provider}} in YarpNeuro.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e inserisci il codice qui sotto per connettere il tuo account e usare i modelli {{provider}} in YarpNeuro.",
  ...
  "dialog.server.description": "Cambia il server YarpNeuro a cui si connette l'app.",
  ...
  "wsl.onboarding.checkingOpencode": "Controllo YarpNeuro...",
  "wsl.onboarding.checkingOpencodeIn": "Controllo YarpNeuro in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aggiornamento YarpNeuro...",
  "wsl.onboarding.updatingOpencodeIn": "Aggiornamento YarpNeuro in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Aggiorna YarpNeuro in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Aggiorna YarpNeuro",
  "wsl.onboarding.opencodeReadyIn": "YarpNeuro è pronto in {{distro}}.",
  "wsl.onboarding.opencodeReady": "YarpNeuro è pronto.",
  "wsl.onboarding.installOpencodeIn": "Installa YarpNeuro in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installa YarpNeuro",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "YarpNeuro non installato",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Sottosistema Windows per Linux) è necessario prima che YarpNeuro possa aggiungere un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL non disponibile",
  "wsl.onboarding.wslUnavailable.description": "YarpNeuro non ha potuto verificare WSL su questa macchina.",
  "wsl.onboarding.installWsl": "Installa WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Riavvia Windows per completare l'installazione WSL, quindi riapri YarpNeuro.",
  ...
  "help.tabs.introduction": "YarpNeuro Desktop ora è incentrato sulle schede.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nuova versione di YarpNeuro ({{version}}) è ora disponibile per l'installazione.",
  ...
  "error.page.report.prefix": "Segnala questo errore al team YarpNeuro",
  ...
  "error.chain.mcpFailed":
    'Il server MCP "{{name}}" non ha funzionato. Nota: YarpNeuro non supporta ancora l\'autenticazione MCP.',
  ...
  "sidebar.gettingStarted.line1": "YarpNeuro include modelli gratuiti così puoi iniziare immediatamente.",
  ...
  "settings.desktop.wsl.description": "Esegui il server YarpNeuro all'interno di WSL su Windows.",
  ...
  "settings.general.row.language.description": "Cambia la lingua di visualizzazione per YarpNeuro",
  ...
  "settings.general.row.appearance.description": "Personalizza l'aspetto di YarpNeuro sul tuo dispositivo",
  "settings.general.row.colorScheme.title": "Combinazione di colori",
  "settings.general.row.colorScheme.description": "Scegli se YarpNeuro segue il tema di sistema, chiaro o scuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizza il tema di YarpNeuro.",
  ...
  "settings.updates.row.startup.description": "Controlla automaticamente gli aggiornamenti all'avvio di YarpNeuro",
  ...
  "settings.updates.toast.latest.title": "YarpNeuro è aggiornato",
  "settings.updates.toast.latest.description": "Stai utilizzando l'ultima versione di YarpNeuro.",
  ...
  "desktop.menu.documentation": "Documentazione di YarpNeuro",
  ...
  "desktop.menu.ariaLabel": "Menu YarpNeuro",
  ...
  "desktop.recovery.loadFailed": "Impossibile caricare YarpNeuro",
  "desktop.recovery.terminated": "La finestra di YarpNeuro si è chiusa in modo imprevisto",
  "desktop.recovery.unresponsive": "YarpNeuro non risponde",
  ...
  "desktop.wsl.error.installOpencode": "Installazione di YarpNeuro non riuscita",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "YarpNeuro non è installato in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "L'aggiornamento di YarpNeuro è terminato, ma {{distro}} segnala ancora la versione {{installed}}; era prevista la versione {{expected}}",
