export const dict = {
  ...
  "desktop.menu.documentation": "Documentação do YarpNeuro",
  ...
  "desktop.menu.ariaLabel": "Menu do YarpNeuro",
  ...
  "desktop.recovery.loadFailed": "Falha ao carregar o YarpNeuro",
  "desktop.recovery.terminated": "A janela do YarpNeuro foi encerrada inesperadamente",
  "desktop.recovery.unresponsive": "O YarpNeuro não está respondendo",
  ...
  "desktop.wsl.error.installOpencode": "Falha na instalação do YarpNeuro",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "O YarpNeuro não está instalado em {{distro}}",
  "desktop.wsl.error.updateVersion":
    "A atualização do YarpNeuro foi concluída, mas {{distro}} ainda informa a versão {{installed}}; a versão esperada é {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo YarpNeuro",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no YarpNeuro.",
  ...
  "provider.connect.opencodeZen.line1":
    "YarpNeuro Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no YarpNeuro.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no YarpNeuro.",
  ...
  "dialog.server.description": "Trocar para qual servidor YarpNeuro este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingOpencode": "Verificando o YarpNeuro...",
  "wsl.onboarding.checkingOpencodeIn": "Verificando o YarpNeuro em {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atualizando o YarpNeuro...",
  "wsl.onboarding.updatingOpencodeIn": "Atualizando o YarpNeuro em {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atualize o YarpNeuro em {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atualizar o YarpNeuro",
  "wsl.onboarding.opencodeReadyIn": "O YarpNeuro está pronto em {{distro}}.",
  "wsl.onboarding.opencodeReady": "O YarpNeuro está pronto.",
  "wsl.onboarding.installOpencodeIn": "Instale o YarpNeuro em {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar o YarpNeuro",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "YarpNeuro não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o YarpNeuro possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O YarpNeuro não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o YarpNeuro novamente.",
  ...
  "help.tabs.introduction": "Agora, o YarpNeuro Desktop é organizado em abas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Uma nova versão do YarpNeuro ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do YarpNeuro",
  ...
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: YarpNeuro ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "YarpNeuro inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor YarpNeuro dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do YarpNeuro",
  ...
  "settings.general.row.appearance.description": "Personalize como o YarpNeuro aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o YarpNeuro segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o YarpNeuro é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o YarpNeuro iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do YarpNeuro.",
