export const dict = {
  ...
  "desktop.menu.documentation": "Documentación de YarpNeuro",
  ...
  "desktop.menu.ariaLabel": "Menú de YarpNeuro",
  ...
  "desktop.recovery.loadFailed": "No se pudo cargar YarpNeuro",
  "desktop.recovery.terminated": "La ventana de YarpNeuro se cerró de forma inesperada",
  "desktop.recovery.unresponsive": "YarpNeuro no responde",
  ...
  "desktop.wsl.error.installOpencode": "No se pudo instalar YarpNeuro",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "YarpNeuro no está instalado en {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La actualización de YarpNeuro finalizó, pero {{distro}} sigue indicando {{installed}}; se esperaba {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por YarpNeuro",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en YarpNeuro.",
  ...
  "provider.connect.opencodeZen.line1":
    "YarpNeuro Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en YarpNeuro.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en YarpNeuro.",
  ...
  "dialog.server.description": "Cambiar el servidor de YarpNeuro al que se conecta esta aplicación.",
  ...
  "wsl.onboarding.checkingOpencode": "Comprobando YarpNeuro...",
  "wsl.onboarding.checkingOpencodeIn": "Comprobando YarpNeuro en {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Actualizando YarpNeuro...",
  "wsl.onboarding.updatingOpencodeIn": "Actualizando YarpNeuro en {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualiza YarpNeuro en {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizar YarpNeuro",
  "wsl.onboarding.opencodeReadyIn": "YarpNeuro está listo en {{distro}}.",
  "wsl.onboarding.opencodeReady": "YarpNeuro está listo.",
  "wsl.onboarding.installOpencodeIn": "Instala YarpNeuro en {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar YarpNeuro",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "YarpNeuro no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que YarpNeuro pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "YarpNeuro no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir YarpNeuro.",
  ...
  "help.tabs.introduction": "YarpNeuro Desktop ahora se organiza en torno a pestañas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nueva versión de YarpNeuro ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Informa de este error al equipo de YarpNeuro",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota: YarpNeuro aún no admite la autenticación MCP.',
  ...
  "sidebar.gettingStarted.line1": "YarpNeuro incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor YarpNeuro dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para YarpNeuro",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve YarpNeuro en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si YarpNeuro sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de YarpNeuro.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia YarpNeuro",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de YarpNeuro.",
