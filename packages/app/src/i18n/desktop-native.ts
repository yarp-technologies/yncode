...
export const DESKTOP_NATIVE_ENGLISH = {
  ...
  "desktop.recovery.loadFailed": "YarpNeuro failed to load",
  "desktop.recovery.terminated": "YarpNeuro window terminated unexpectedly",
  "desktop.recovery.unresponsive": "YarpNeuro is not responding",
  ...
  "desktop.wsl.error.installOpencode": "YarpNeuro installation failed",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "YarpNeuro is not installed in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "YarpNeuro update finished but {{distro}} still reports {{installed}}; expected {{expected}}",
