export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af YarpNeuro",
  ...
  "provider.connect.apiKey.description":
    "Indtast din API-nøgle til {{provider}} for at forbinde din konto og bruge modeller fra {{provider}} i YarpNeuro.",
  ...
  "provider.connect.opencodeZen.line1":
    "YarpNeuro Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode, forbinde din konto og bruge modeller fra {{provider}} i YarpNeuro.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge modeller fra {{provider}} i YarpNeuro.",
  ...
  "dialog.server.description": "Skift hvilken YarpNeuro-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingOpencode": "Tjekker YarpNeuro...",
  "wsl.onboarding.checkingOpencodeIn": "Tjekker YarpNeuro i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Opdaterer YarpNeuro...",
  "wsl.onboarding.updatingOpencodeIn": "Opdaterer YarpNeuro i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Opdater YarpNeuro i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Opdater YarpNeuro",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "YarpNeuro er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før YarpNeuro kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "YarpNeuro kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter YarpNeuro igen.",
  ...
  "toast.update.description": "En ny version af YarpNeuro ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til YarpNeuro-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, YarpNeuro understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "YarpNeuro inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør YarpNeuro-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for YarpNeuro",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan YarpNeuro ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description":
    "Vælg, om YarpNeuro skal følge systemtemaet eller bruge et lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas YarpNeuros tema.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når YarpNeuro starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af YarpNeuro.",
  ...
  "desktop.recovery.loadFailed": "YarpNeuro kunne ikke indlæses",
  "desktop.recovery.terminated": "YarpNeuro-vinduet blev uventet afsluttet",
  ...
  "desktop.wsl.error.installOpencode": "Installationen af YarpNeuro mislykkedes",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "YarpNeuro er ikke installeret i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Opdateringen af YarpNeuro er fuldført, men {{distro}} rapporterer stadig {{installed}}. Forventet: {{expected}}",
  ...
  "help.tabs.introduction": "YarpNeuro Desktop er nu bygget op omkring faner.",
  "help.tabs.sessions":
